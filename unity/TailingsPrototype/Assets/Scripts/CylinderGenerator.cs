// https://forum.unity.com/threads/how-to-generate-cylinder-through-code-c.762890/
...
public class CylinderGenerator : MonoBehaviour {
    ...
    private int[] tris;
    private int[] FinalTri;
    private int[] firstplane;
    ...
    private void Start() {
        ...
        mesh = new Mesh();
        MakingVertices(1, iter, leng, 0.5f);
    }

    private void MakingVertices(int radius, int iterations, int lenggth, float gap) {
        float x;
        float y;
        float z = 0;
        int i;
